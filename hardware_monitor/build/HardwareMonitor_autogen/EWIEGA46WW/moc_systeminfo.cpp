...
QT_MOC_LITERAL(1, 11, 12), // "statsUpdated"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 8), // "cpuUsage"
QT_MOC_LITERAL(4, 34, 8), // "memUsage"
QT_MOC_LITERAL(5, 43, 11) // "updateStats"

    },
    "SystemInfo\0statsUpdated\0\0cpuUsage\0"
    "memUsage\0updateStats"
};
...
void SystemInfo::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->statsUpdated((*reinterpret_cast< double(*)>(_a[1])),(*reinterpret_cast< double(*)>(_a[2]))); break;
        ...
        {
            using _t = void (SystemInfo::*)(double , double );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SystemInfo::statsUpdated)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SystemInfo::statsUpdated(double _t1, double _t2)
{
